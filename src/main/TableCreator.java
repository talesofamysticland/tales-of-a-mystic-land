...
public class TableCreator {
    ...
    public static void main(String[] args) throws SQLException{
        ...
        String sql = "CREATE TABLE Resolution(id INT PRIMARY KEY, width INT, height INT);";
        Statement stm = conn.createStatement();
        stm.execute(sql);

        sql = "CREATE TABLE Settings(id INT, id_resolution INT, volume_effects NUMERIC(3,1),volume_music NUMERIC(3,1), volume_geral NUMERIC(3,1), full_screen BOOLEAN, save_date DATETIME,PRIMARY KEY (id), FOREIGN KEY (id_resolution) REFERENCES Resolution(id));";
        ...
        sql = "CREATE TABLE Item_in_inventory(id INT PRIMARY KEY, id_save_state INT, id_item INT, amount INT,position INT, FOREIGN KEY (id_item) REFERENCES Item(id), FOREIGN KEY (id_save_state) REFERENCES Save_state(id));";
        stm = conn.createStatement();
        stm.execute(sql);
